...
describe("cut", function() {
  ...
  it("display should get error message if any wrong argument is given", function() {
    const mockedEmitter = new Events();
    mockedEmitter.resume = () => {};
  ...
  it("error event should get an error object for having any problem in file", function() {
    const mockedEmitter = new Events();
    mockedEmitter.resume = () => {};
